...
<head>
  ...
  <link rel="stylesheet" href="{{asset('assets/css/login/css/style.css')}}" />
      ...
      <li class="nav-item dropdown">
        ...
        <div class="dropdown-menu dropdown-menu-lg dropdown-menu-right">
          <a href="#" class="dropdown-item">
            <!-- Message Start -->
            <div class="media">
              <img src="{{asset('assets/dahboard/dist/img/user1-128x128.jpg')}}" alt="User Avatar" class="mr-3 img-size-50 img-circle">
          ...
          <a href="#" class="dropdown-item">
            <!-- Message Start -->
            <div class="media">
              <img src="{{asset('assets/dashboard/dist/img/user8-128x128.jpg')}}" alt="User Avatar" class="mr-3 img-size-50 img-circle">
              <div class="media-body">
                <h3 class="dropdown-item-title">
                  John Pierce
          ...
          <a href="#" class="dropdown-item">
            <!-- Message Start -->
            <div class="media">
              <img src="{{asset('assets/dashboard/dist/img/user3-128x128.jpg')}}" alt="User Avatar" class="mr-3 img-size-50 img-circle">
              <div class="media-body">
                <h3 class="dropdown-item-title">
                  Nora Silvester
 ...
 wire:
  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <a href="{{route('index')}}" class="brand-link">
      ...
      <span class="brand-text font-weight-light">IT/Next</span>
    </a>
