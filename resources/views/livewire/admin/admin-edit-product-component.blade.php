...
input[type="file"] {
    ...
    <form class="form-stl" enctype="multipart/form-data" wire:submit.prevent="updateproduct" >
        @csrf
        ...
        <fieldset class="wrap-input">
            ...
            <textarea   placeholder="your short_descripation*" :value="short_descripation"   wire:model="short_descripation"></textarea>
        ...
        <fieldset class="wrap-input">
            ...
            <textarea   placeholder="your descripation*" :value="descripation"   wire:model="descripation"></textarea>
            @error('descripation')
            <p class="text-danger">{{$message}}</p>
            @enderror
        </fieldset>
        ...
        <fieldset class="wrap-input">
            ...
            <input type="file"  name="newimage" placeholder="your image*" :value="newimage"   autocomplete="newimage" wire:model="newimage">

                @if($newimage)
                <img src="{{$newimage->temporaryUrl()}}" width="120px" />
                @else
                <img src="{{asset('assets/images/it_service')}}/{{$image.'.jpg'}}" width="120px" />
                @endif
                @error('newimage')
                <p class="text-danger">{{$message}}</p>
                @enderror
