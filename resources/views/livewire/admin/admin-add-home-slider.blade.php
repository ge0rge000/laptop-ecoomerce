...
input[type="file"] {
    ...
    @if(Session::has('message'))
        ...
        @endif
    <form class="form-stl" wire:submit.prevent="storeslider"  enctype="multipart/form-data">
        @csrf
        <fieldset class="wrap-title">
            <h3 class="form-title">Create Slider</h3>

        </fieldset>
        <fieldset class="wrap-input">
            <label for="frm-reg-lname">title</label>
            <input type="text" id="frm-reg-lname" name="title" placeholder="title name*" :value="category" required autofocus autocomplete="title" wire:model="title"  >
        </fieldset>
        <fieldset class="wrap-input">
        ...
        <fieldset class="wrap-input">
            ...
            <input type="file"   name="image" placeholder="your image*" :value="image" wire:model='image' required>
            @if($image)
